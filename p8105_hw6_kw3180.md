...
<img src="p8105_hw6_kw3180_files/figure-gfm/unnamed-chunk-11-3.png" width="90%" />
...
- The first plot shows that the residuals for the hypothesized model is
  ...
  noticeable skewing on the left-hand side.
- The “Residuals vs Fitted Values for Hypothesis Model” is used to
  assess linearity and homoscedasticity. The roughly oval shape centered
  around 0 indicates the model is mostly linear, but there is some
  non-constant variance (heteroskedasticity), with slightly more spread
  in residuals at lower fitted birthweights..
